...
class EvaluatorBuilder {
    public static Evaluator build(Evaluator.TYPE type) throws InvalidEvaluation {
        switch (type){
            ...
            case NO_CRIMINAL_RECORD_AND_MORE_EXPERIENCE: return new CriminalRecord(new Experience(null));
            case MORE_EXPERIENCE_AND_MORE_CREDIT_SCORE: return new Experience(new CreditScore(null));
            case NO_CRIMINAL_RECORD_AND_MORE_CREDIT_SCORE: return new CriminalRecord(new CreditScore(null));
